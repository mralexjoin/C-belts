...
public:
  ...
  const geo2d::Point& GetFigure() const {
    return figure;
  }
private:
  const geo2d::Point figure;
};
...
public:
  ...
  bool CollideWith(const Tower& that) const override;
  bool CollideWith(const Fence& that) const override;
  const geo2d::Rectangle& GetFigure() const {
    return figure;
  }
private:
  const geo2d::Rectangle figure;
};
...
public:
  ...
  bool CollideWith(const Tower& that) const override;
  bool CollideWith(const Fence& that) const override;
  const geo2d::Circle& GetFigure() const {
    return figure;
  }
private:
  const geo2d::Circle figure;
};
...
public:
  ...
  bool CollideWith(const Tower& that) const override;
  bool CollideWith(const Fence& that) const override;
  const geo2d::Segment& GetFigure() const {
    return figure;
  }
private:
  const geo2d::Segment figure;
};

bool Unit::CollideWith(const Unit& that) const {
  return geo2d::Collide(this->GetFigure(), that.GetFigure());
}
